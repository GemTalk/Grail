# GRAIL: CPython 3.14.7's xml/sax/expatreader.py, VERBATIM.
#
# Vendored UNMODIFIED on purpose.  It is the tested upstream SAX driver, and
# matching pyexpat's API exactly -- rather than inventing a nicer one -- is
# what lets this file run as written instead of being re-derived here.
"""
