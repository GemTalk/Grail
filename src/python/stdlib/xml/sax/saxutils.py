...
#
# _gettextwriter is what exposed two real io defects: its first branch is
# ``isinstance(out, io.TextIOBase)'', and Grail's StringIO was outside _pyio's
# ABC hierarchy, so a StringIO fell through to the hand-built BufferedIOBase
# path and died there.  See io_module.gs >> ___registerGrailStreams___:.
"""\
