# GRAIL: CPython 3.14.7's xml/etree/ElementPath.py, VERBATIM.  Pure Python, no
# imports beyond re and collections -- it is the ElementPath (XPath subset)
# engine behind find/findall/iterfind, which the old shim did not have at all.
#
# ElementTree
