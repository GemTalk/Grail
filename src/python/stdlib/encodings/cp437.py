...
"""#"
#
# GRAIL: upstream CPython 3.14.7, verbatim.  It is here because CPython's
# zipfile decodes every member name that lacks the UTF-8 flag with cp437 --
# the historical ZIP filename encoding -- and CPython itself sets that flag only
# for non-ASCII names, so it is the encoding of most archives in existence.
# Without it the real zipfile could not LIST an ordinary archive.
