...
#
# GRAIL: upstream CPython 3.14.6, VERBATIM -- a generated charmap table,
# copied rather than transcribed.  Vendored with the rest of the charmap
# family so every single-byte codec in test_codecs' all_unicode_encodings
# resolves.
