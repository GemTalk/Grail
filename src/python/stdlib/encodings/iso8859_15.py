...
# copied rather than transcribed.  Latin-9 is Latin-1 with the euro sign
# at 0xa4 and seven other substitutions, and is reached as ``latin9'',
# ``L9'' or ``iso-8859-15'' -- though NOT as ``latin-9'', which aliases.py
# has no entry for.
