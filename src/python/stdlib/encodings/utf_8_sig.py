...
"""
#
# GRAIL: upstream CPython 3.14.6, verbatim.  It works unchanged because it
# binds no codec entry point directly into a class body -- see the note in
# encodings/utf_8.py for why that spelling has to be expanded here.
import codecs
