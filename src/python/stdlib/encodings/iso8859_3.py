...
#
# GRAIL: upstream CPython 3.14.7, VERBATIM -- a generated charmap table,
# copied rather than transcribed.  It is here for its HOLES: 0xa5 and its
# neighbours are unmapped, which is what makes it the codec test_codecs
# uses to exercise ``surrogateescape'' over a charmap (SurrogateEscapeTest
# test_charmap).
