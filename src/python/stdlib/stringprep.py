...
"""
#
# GRAIL: upstream CPython 3.14.6, VERBATIM.  It reads Unicode 3.2.0 through
# ``unicodedata.ucd_3_2_0``, which Grail generates from CPython's own tables
# (scripts/generate_ucd.py) rather than stubbing.
