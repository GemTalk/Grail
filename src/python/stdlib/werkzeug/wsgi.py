...
# Grail-patched: io.RawIOBase isn't yet in Grail's io module stub.
# LimitedStream uses the base mainly for isinstance/io-protocol
# tagging; the actual read methods are overridden below.
class LimitedStream:
