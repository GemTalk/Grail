...
def dis(code):
    # GRAIL: dis() is a heavy-nested-closures debug disassembler
    # that trips codegen.  Stubbed out because the regex engine
    # never calls it on the compile path.  See TODO.md for the
    # full revert condition.
    raise NotImplementedError("re._compiler.dis() not yet ported in Grail")
