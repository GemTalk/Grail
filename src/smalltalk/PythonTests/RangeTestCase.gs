...
test__bool__
	...
	r := Interval @env1:__new__: Interval _: 0 _: 0.
	self deny: (r @env1:__bool__).

	"Non-empty range is True"
	r := Interval @env1:__new__: Interval _: 0 _: 1.
...
test__eq__
	...
	| r1 r2 r3 |
	r1 := Interval @env1:__new__: Interval _: 0 _: 10.
	r2 := Interval @env1:__new__: Interval _: 0 _: 10 _: 1.
	r3 := Interval @env1:__new__: Interval _: 0 _: 10 _: 2.
	...
	r1 := Interval @env1:__new__: Interval _: 0 _: 0.
	r2 := Interval @env1:__new__: Interval _: 5 _: 5.
	self assert: (r1 @env1:__eq__: r2).
%
...
test__getitem__
	...
	| r |
	r := Interval @env1:__new__: Interval _: 5 _: 10.
...
test__getitem__outOfRange
	...
	| r |
	r := Interval @env1:__new__: Interval _: 0 _: 5.
...
test__len__
	...
	r := Interval @env1:__new__: Interval _: 10 _: 0 _: -1.
	self assert: r size equals: 10.
%
...
test__ne__
	...
	| r1 r2 |
	r1 := Interval @env1:__new__: Interval _: 0 _: 10.
	r2 := Interval @env1:__new__: Interval _: 0 _: 10 _: 2.
...
test__new__emptyRange
	...
	| result |
	"range(0, 0) is empty"
	result := Interval @env1:__new__: Interval _: 0 _: 0.
	self assert: result size equals: 0.
	
	"range(5, 5) is empty"
	result := Interval @env1:__new__: Interval _: 5 _: 5.
	self assert: result size equals: 0.
%
...
test__new__negativeStep
	...
	result := Interval @env1:__new__: Interval _: 10 _: 0 _: -2.
...
test__new__threeArgs
	...
	result := Interval @env1:__new__: Interval _: 0 _: 10 _: 2.
	self assert: (result @env1:start) equals: 0.
...
test__new__twoArgs
	...
	result := Interval @env1:__new__: Interval _: 2 _: 7.
...
test__new__zeroStepRaisesError
	...
	self 
		should: [Interval @env1:__new__: Interval _: 0 _: 10 _: 0]
		raise: ValueError.
%
...
test__repr__
	...
	r := Interval @env1:__new__: Interval _: 1 _: 5.
	result := r @env1:__repr__.
...
test_startStopStep
	...
	| r |
	r := Interval @env1:__new__: Interval _: 1 _: 10 _: 2.
