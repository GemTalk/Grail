...
! RUNNING CPython 3.14.6.  All 17 comparable probes agree with CPython exactly.
! The eighteenth, ``connect_progression'', has no portable CPython answer to
! compare against -- a refused loopback connect reports ConnectionRefusedError
