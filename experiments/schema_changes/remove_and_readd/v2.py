...
assert [r["name"] for r in gemdb.schema.layout(Account)] == ["balance", "owner"], "unchanged"
...
gemdb.commit()
print("v2: layout =", [r["name"] for r in gemdb.schema.layout(Account)], " acct.balance =", acct.balance,
