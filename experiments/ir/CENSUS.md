...
**stdlib**: 1570 top-level defs, **1160 compiled through IR (73.9%)**; 4427 class-body methods, of which **2628 are IR-eligible (59.4%)** through the class-method seam (cut 36); 204 nested defs/lambdas. Of all 6201 defs the corpus holds, 61.1% go through IR.

| defs | share of top-level | reason | examples |
| ---: | ---: | --- | --- |
| 1160 | 73.9% | `compiled` | _codecs.normalizestring, _codecs.register, _codecs.unregister, _codecs.lookup, _codecs._forget_codec |
| 64 | 4.1% | `stmt:FunctionDefAst` | re._parser.parse_template, _py_warnings._warn_unawaited_coroutine, types._derive_code_type, types._derive_cell_type, typ |
| 44 | 2.8% | `value:ListCompAst` | _codecs.xmlcharrefreplace_errors, _codecs.backslashreplace_errors, _codecs.namereplace_errors, re._compiler._mk_bitmap,  |
...
| 24 | 1.5% | `value:GeneratorExpAst` | re._compiler._hex_code, _py_warnings._is_filename_to_skip, _typing._union_getitem, typing._type_repr, typing._check_gene |
...
| 12 | 0.8% | `stmt:AnnAssignAst` | werkzeug.test.stream_encode_multipart, werkzeug.test.run_wsgi_app, werkzeug.http.parse_dict_header, werkzeug.http.parse_ |
...
| ---: | ---: | --- | --- |
| 2628 | 59.4% | `eligible` | __future__._Feature.__init__, __future__._Feature.getOptionalRelease, __future__._Feature.getMandatoryRelease, __future_ |
...
| 261 | 5.9% | `CallAst:selfSendKeywordsOrArity` | _markupbase.ParserBase.parse_declaration, _markupbase.ParserBase._parse_doctype_subset, re._parser.Tokenizer.getuntil, r |
| 233 | 5.3% | `NameAst:moduleFunctionInMethod` | _pyio.BufferedReader.__init__, _pyio.BufferedWriter.__init__, _pyio.TextIOWrapper.__init__, _strptime.LocaleTime.__init_ |
| 173 | 3.9% | `NameAst:super-__class__-type` | re._constants.PatternError.__init__, _py_warnings.deprecated.__call__, _pyio.BytesIO.close, _pyio.FileIO.close, _pyio.St |
| 79 | 1.8% | `stmt:AnnAssignAst` | asyncio.timeouts.Timeout.__init__, blinker.base.Signal.__init__, blinker.base.Signal.disconnect, werkzeug.test.Client.op |
| 75 | 1.7% | `value:StarredAst` | argparse.HelpFormatter._format_usage, argparse._ActionsContainer.add_argument, argparse._ActionsContainer.add_argument_g |
...
| 60 | 1.4% | `value:ListCompAst` | _strptime.LocaleTime.__calc_weekday, _strptime.LocaleTime.__calc_month, _strptime.LocaleTime.__calc_alt_digits, argparse |
| 57 | 1.3% | `stmt:FunctionDefAst` | _pyio.IOBase.readline, _pyio.TextIOWrapper.seek, _strptime.TimeRE.pattern, argparse.HelpFormatter._format_action_invocat |
| 49 | 1.1% | `AugAssignAst:target-NameAst` | re._parser.Tokenizer.__next, re._parser.Tokenizer.getwhile, _pyio.IOBase.readlines, _pyio.BytesIO.__init__, _pyio.Buffer |
| 48 | 1.1% | `AugAssignAst:target-AttributeAst` | _pyio.BytesIO.write, _pyio.IncrementalNewlineDecoder.decode, _pyio.TextIOWrapper._get_decoded_chars, _pyio.TextIOWrapper |
| 47 | 1.1% | `CallAst:doubleStarKwargs` | argparse._SubParsersAction.add_parser, argparse._ActionsContainer.add_mutually_exclusive_group, argparse.ArgumentParser. |
...
| 41 | 0.9% | `value:GeneratorExpAst` | _pyio.FileIO.__init__, argparse.RawDescriptionHelpFormatter._fill_text, argparse.FileType.__call__, argparse.ArgumentPar |
...
| 24 | 0.5% | `AssignAst:chained` | re._parser.SubPattern.getwidth, _py_warnings.catch_warnings.__enter__, _strptime.LocaleTime.__find_month_format, _strpti |
...
| 14 | 0.3% | `value:LambdaAst` | argparse.HelpFormatter.add_argument, werkzeug.datastructures.auth.WWWAuthenticate.parameters, werkzeug.routing.map.Map.u |
| 13 | 0.3% | `NameAst:builtinFunctionAsValue` | _pyio.BufferedIOBase._readinto, _pyio.BufferedReader._readinto, _strptime.TimeRE.__seqToRE, operator.attrgetter.__repr__ |
...
| 11 | 0.2% | `value:NamedExprAst` | _pyio.IOBase.__del__, _pyio.RawIOBase.readall, _pyio._BufferedIOMixin._dealloc_warn, _pyio.FileIO.readall, _pyio.TextIOW |
| 7 | 0.2% | `RaiseAst:keywords` | subprocess.Popen.communicate, jinja2.environment.Environment.handle_exception, jinja2.environment.Environment.select_tem |
| 6 | 0.1% | `value:DictCompAst` | collections.deque.__deepcopy__, selectors.SelectSelector.select, werkzeug.routing.map.MapAdapter.build, jinja2.environme |
...
| 5 | 0.1% | `flow` | _pyio.TextIOWrapper._read_chunk, argparse.HelpFormatter._format_action, argparse._ActionsContainer._get_optional_kwargs, |
| 3 | 0.1% | `CallAst:frameSensitive-dir` | unittest.TestLoader.getTestCaseNames, unittest.TestLoader.loadTestsFromModule, flask.config.Config.from_object |
...
| 2 | 0.0% | `CallAst:frameSensitive-locals` | jinja2.environment.Environment.overlay, pydoc.HTMLDoc.docmodule |
| 2 | 0.0% | `ForAst:else` | werkzeug.routing.matcher.StateMachineMatcher.add, sqlparse.lexer.Lexer.is_keyword |
| 2 | 0.0% | `value:SetCompAst` | werkzeug.datastructures.structures.HeaderSet.__init__, flask.sansio.app.App.add_url_rule |
...
**test corpus, everything compiled**: 2731 top-level defs, **2102 compiled through IR (77.0%)**; 13550 class-body methods, of which **6629 are IR-eligible (48.9%)** through the class-method seam (cut 36); 257 nested defs/lambdas. Of all 16538 defs the corpus holds, 52.8% go through IR.

**`test.*` modules alone**: 386 top-level defs, 273 compiled (70.7%); 8515 class methods (test code is almost entirely TestCase methods), of which 3413 IR-eligible; 69 nested.

| methods | share of class methods | reason | examples |
| ---: | ---: | --- | --- |
| 3413 | 40.1% | `eligible` | test.test_textwrap.BaseTestCase.check, test.test_textwrap.BaseTestCase.check_split, test.test_textwrap.WrapTestCase.setU |
...
| 836 | 9.8% | `stmt:ClassDefAst` | test.test_math.MathTests.testCeil, test.test_math.MathTests.testFloor, test.test_math.MathTests.test_trunc, test.test_ma |
| 593 | 7.0% | `stmt:FunctionDefAst` | test.test_math.MathTests.testFrexp, test.test_math.MathTests.testFsum, test.test_math.MathTests.testModf, test.test_math |
| 283 | 3.3% | `NameAst:moduleFunctionInMethod` | unittest.TestCase.id, unittest.TestCase.__str__, unittest.TestCase.__repr__, unittest.TestCase.run, unittest.TestSuite._ |
| 265 | 3.1% | `CallAst:selfSendKeywordsOrArity` | test.test_textwrap.ShortenTestCase.test_simple, test.test_textwrap.ShortenTestCase.test_placeholder, test.test_textwrap. |
...
| 135 | 1.6% | `NameAst:builtinFunctionAsValue` | operator.attrgetter.__repr__, operator.itemgetter.__repr__, operator.methodcaller.__repr__, test.test_float.GeneralFloat |
| 116 | 1.4% | `value:LambdaAst` | test.test_textwrap.IndentTestCase.test_indent_nomargin_all_lines, test.test_textwrap.IndentTestCase.test_indent_no_lines |
| 103 | 1.2% | `stmt:AsyncFunctionDefAst` | contextlib.AsyncContextDecorator.__call__ |
| 95 | 1.1% | `value:ListCompAst` | collections.OrderedDict.values, collections.OrderedDict.items, collections.Counter._keep_positive, collections.ChainMap. |
...
| 63 | 0.7% | `NameAst:super-__class__-type` | unittest.async_case.IsolatedAsyncioTestCase.__init__, unittest.async_case.IsolatedAsyncioTestCase.run, unittest.async_ca |
...
| 56 | 0.7% | `flow` | test.test_textwrap.BaseTestCase.show, test.test_math.MathTests.testHypotAccuracy, test.test_math.MathTests.test_exceptio |
| 48 | 0.6% | `ConstantAst:complex` | test.test_operator.OperatorTestCase.test_lt, test.test_operator.OperatorTestCase.test_le, test.test_operator.OperatorTes |
| 44 | 0.5% | `AugAssignAst:target-AttributeAst` | collections._deque_iterator.__next__, collections.deque.append, collections.deque.appendleft, collections.deque.pop, col |
...
| 4 | 0.0% | `ForAst:else` | test.datetimetester.TestDateTimeTZ.test_tzinfo_now, test.test_re.ReTests.test_locale_flag |
