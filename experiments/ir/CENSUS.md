...
**stdlib**: 1588 top-level defs, **1588 compiled through IR (100.0%)**; 4604 class-body methods, of which **4604 are IR-eligible (100.0%)** through the class-method seam (cut 36); 204 nested defs/lambdas. Of all 6396 defs the corpus holds, 96.8% go through IR.

| defs | share of top-level | reason | examples |
| ---: | ---: | --- | --- |
| 1588 | 100.0% | `compiled` | _codecs._bootstrap, _codecs.lookup, _codecs.normalizestring, _codecs.register, _codecs.unregister |
...
| ---: | ---: | --- | --- |
| 4604 | 100.0% | `eligible` | __future__._Feature.__init__, __future__._Feature.__repr__, __future__._Feature.getMandatoryRelease, __future__._Feature |
...
| typing | 85 | 85 | 100% | 133 | `cm:eligible` (133) |
...
| unittest | 10 | 10 | 100% | 107 | `cm:eligible` (107) |
