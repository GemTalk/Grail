...
test__new__onComplex
	...
	a := complex ___real: 1 imaginary: 2.
	self
		assert: ((complex __call__: a) __eq__: a);
		yourself.
%
category: 'done'
method: complexTest
...
test__new__onString
	...
	self
		assert: (complex __call__: (str ___value: '(1+3j)')) __repr__ ___value equals: '(1+3j)';
		assert: (complex __call__: (str ___value: '(1-3j)')) __repr__ ___value equals: '(1-3j)';
	   	assert: (complex __call__: (str ___value: '(+1+0j)')) __repr__ ___value equals: '(1+0j)';
		assert: (complex __call__: (str ___value: '(-1+0j)')) __repr__ ___value equals: '(-1+0j)';
		assert: (complex __call__: (str ___value: '-3j'	)) __repr__ ___value equals: '-3j';
		assert: (complex __call__: (str ___value: '+3j'	)) __repr__ ___value equals: '3j';
		assert: (complex __call__: (str ___value: '3j'	)) __repr__ ___value equals:  '3j';
		yourself.
	[
		complex __call__: (str ___value: '(1-3j').
		self assert: false.
	] on: ValueError do: [:ex |
		self assert: ex messageText equals: 'complex() arg is a malformed string'.
	].
...
test__new__twoParams
	...
	[
		self targetClass __call__: (self int: 1) _: Set new.
		self assert: false.
	] on: TypeError do: [:ex |
		self assert: ex messageText equals: 'complex() second argument must be a number, not ''Set'''.
	].
	[
		self targetClass __call__: (self str: 'Set new') _: (self int: 1).
		self assert: false.
	] on: TypeError do: [:ex |
