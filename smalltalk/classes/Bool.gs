...
! ------------------- Arithmetic operations (inherited from int behavior)
! Booleans participate in arithmetic as 1 (True) or 0 (False)
...
! These methods allow bool to participate in GemStone's numeric coercion system
...
! These allow bool to participate in Smalltalk arithmetic expressions
