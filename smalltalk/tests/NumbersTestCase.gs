...
testNumbersModuleExists
	...
	| nm |
	nm := numbers perform: #instance env: 2.
...
testNumbersModuleProvidesNumber
	...
	| nm numberABC |
	nm := numbers perform: #instance env: 2.
	numberABC := nm perform: #Number env: 2.
...
testNumbersModuleProvidesComplex
	...
	| nm complexABC |
	nm := numbers perform: #instance env: 2.
	complexABC := nm perform: #Complex env: 2.
...
testNumbersModuleProvidesRational
	...
	| nm rationalABC |
	nm := numbers perform: #instance env: 2.
	rationalABC := nm perform: #Rational env: 2.
...
testNumbersModuleProvidesIntegral
	...
	| nm integralABC |
	nm := numbers perform: #instance env: 2.
	integralABC := nm perform: #Integral env: 2.
	self assert: integralABC equals: numbers_Integral.
%

! ------------------- Tests for ABC hierarchy
...
! ------------------- Tests for __instancecheck__ on Integral
...
testIntegerIsInstanceOfIntegral
	...
	self assert: (numbers_Integral perform: #__instancecheck__: env: 2 withArguments: {5}).
%
...
testSmallIntegerIsInstanceOfIntegral
	...
	self assert: (numbers_Integral perform: #__instancecheck__: env: 2 withArguments: {42}).
%
...
testBoolIsInstanceOfIntegral
	...
	self assert: (numbers_Integral perform: #__instancecheck__: env: 2 withArguments: {true}).
	self assert: (numbers_Integral perform: #__instancecheck__: env: 2 withArguments: {false}).
%
...
testFloatIsNotInstanceOfIntegral
	...
	self deny: (numbers_Integral perform: #__instancecheck__: env: 2 withArguments: {3.14}).
%

! ------------------- Tests for __instancecheck__ on Real
...
testFloatIsInstanceOfReal
	...
	self assert: (numbers_Real perform: #__instancecheck__: env: 2 withArguments: {3.14}).
%
...
testIntegerIsInstanceOfReal
	...
	self assert: (numbers_Real perform: #__instancecheck__: env: 2 withArguments: {5}).
%

! ------------------- Tests for __instancecheck__ on Rational
...
testFractionIsInstanceOfRational
	...
	| frac |
	frac := Fraction perform: #__new__:_:_: env: 2 withArguments: {Fraction. 1. 2}.
	self assert: (numbers_Rational perform: #__instancecheck__: env: 2 withArguments: {frac}).
%
...
testIntegerIsInstanceOfRational
	...
	self assert: (numbers_Rational perform: #__instancecheck__: env: 2 withArguments: {5}).
%

! ------------------- Tests for __instancecheck__ on Complex
...
testComplexIsInstanceOfComplex
	...
	| c |
	c := complex perform: #__new__:_: env: 2 withArguments: {1.0. 2.0}.
	self assert: (numbers_Complex perform: #__instancecheck__: env: 2 withArguments: {c}).
%
...
testFloatIsInstanceOfComplex
	...
	self assert: (numbers_Complex perform: #__instancecheck__: env: 2 withArguments: {3.14}).
%
...
testIntegerIsInstanceOfComplex
	...
	self assert: (numbers_Complex perform: #__instancecheck__: env: 2 withArguments: {5}).
%

! ------------------- Tests for __instancecheck__ on Number
...
testIntegerIsInstanceOfNumber
	...
	self assert: (numbers_Number perform: #__instancecheck__: env: 2 withArguments: {5}).
%
...
testFloatIsInstanceOfNumber
	...
	self assert: (numbers_Number perform: #__instancecheck__: env: 2 withArguments: {3.14}).
%
...
testComplexIsInstanceOfNumber
	...
	| c |
	c := complex perform: #__new__:_: env: 2 withArguments: {1.0. 2.0}.
	self assert: (numbers_Number perform: #__instancecheck__: env: 2 withArguments: {c}).
%
...
testStringIsNotInstanceOfNumber
	...
	self deny: (numbers_Number perform: #__instancecheck__: env: 2 withArguments: {'hello'}).
%
...
testListIsNotInstanceOfNumber
	...
	self deny: (numbers_Number perform: #__instancecheck__: env: 2 withArguments: {lst}).
%
